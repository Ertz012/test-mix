...
def main():
    ...
    try:
        ...
        remote_cmd = f"cd {remote_repo_path} && echo '{PASS}' | sudo -S nohup python3 tools/run_series.py --experiments config/experiments_no_noise.json > experiment_output.log 2>&1 & echo $!"
